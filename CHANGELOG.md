...
## [1.5.5](https://github.com/awslabs/cognito-at-edge/tree/1.5.5) (2026-08-18)

[Full Changelog](https://github.com/awslabs/cognito-at-edge/compare/1.5.4...1.5.5)

**Merged pull requests:**

- fix: remove double-encoding of the state param [\#145](https://github.com/awslabs/cognito-at-edge/pull/145) ([Pavelurv](https://github.com/Pavelurv))
- chore: bump axios from 1.16.0 to 1.18.0 [\#143](https://github.com/awslabs/cognito-at-edge/pull/143) ([dependabot[bot]](https://github.com/apps/dependabot))
- chore: bump form-data from 4.0.5 to 4.0.6 [\#142](https://github.com/awslabs/cognito-at-edge/pull/142) ([dependabot[bot]](https://github.com/apps/dependabot))
- chore: bump axios from 1.15.2 to 1.16.0 [\#141](https://github.com/awslabs/cognito-at-edge/pull/141) ([dependabot[bot]](https://github.com/apps/dependabot))
- chore: bump axios from 1.15.0 to 1.15.2 [\#140](https://github.com/awslabs/cognito-at-edge/pull/140) ([dependabot[bot]](https://github.com/apps/dependabot))
- chore: bump follow-redirects from 1.15.11 to 1.16.0 [\#139](https://github.com/awslabs/cognito-at-edge/pull/139) ([dependabot[bot]](https://github.com/apps/dependabot))
- chore: bump axios from 1.13.5 to 1.15.0 [\#138](https://github.com/awslabs/cognito-at-edge/pull/138) ([dependabot[bot]](https://github.com/apps/dependabot))
- chore: bump brace-expansion [\#137](https://github.com/awslabs/cognito-at-edge/pull/137) ([dependabot[bot]](https://github.com/apps/dependabot))
- chore: bump handlebars from 4.7.8 to 4.7.9 [\#136](https://github.com/awslabs/cognito-at-edge/pull/136) ([dependabot[bot]](https://github.com/apps/dependabot))
- chore: bump yaml from 2.8.2 to 2.8.3 [\#135](https://github.com/awslabs/cognito-at-edge/pull/135) ([dependabot[bot]](https://github.com/apps/dependabot))
- chore: bump picomatch [\#134](https://github.com/awslabs/cognito-at-edge/pull/134) ([dependabot[bot]](https://github.com/apps/dependabot))
- chore: bump flatted from 3.4.1 to 3.4.2 [\#133](https://github.com/awslabs/cognito-at-edge/pull/133) ([dependabot[bot]](https://github.com/apps/dependabot))
- chore: bump flatted from 3.3.3 to 3.4.1 [\#131](https://github.com/awslabs/cognito-at-edge/pull/131) ([dependabot[bot]](https://github.com/apps/dependabot))
- chore: bump minimatch [\#130](https://github.com/awslabs/cognito-at-edge/pull/130) ([dependabot[bot]](https://github.com/apps/dependabot))
- chore: bump ajv from 6.12.6 to 6.14.0 [\#129](https://github.com/awslabs/cognito-at-edge/pull/129) ([dependabot[bot]](https://github.com/apps/dependabot))
- Upgrade tooling including linting and formatting [\#127](https://github.com/awslabs/cognito-at-edge/pull/127) ([jeandek](https://github.com/jeandek))
- chore: bump axios from 1.12.0 to 1.13.5 [\#126](https://github.com/awslabs/cognito-at-edge/pull/126) ([dependabot[bot]](https://github.com/apps/dependabot))

## [1.5.4](https://github.com/awslabs/cognito-at-edge/tree/1.5.4) (2026-01-30)

[Full Changelog](https://github.com/awslabs/cognito-at-edge/compare/1.5.3...1.5.4)

**Merged pull requests:**

- chore: bump lodash from 4.17.21 to 4.17.23 [\#123](https://github.com/awslabs/cognito-at-edge/pull/123) ([dependabot[bot]](https://github.com/apps/dependabot))
- chore: bump js-yaml from 3.14.1 to 3.14.2 [\#119](https://github.com/awslabs/cognito-at-edge/pull/119) ([dependabot[bot]](https://github.com/apps/dependabot))
